...
module vga_adapter(
	 ...
	 * a given resolution.
	 */
	input [((RESOLUTION == "320x240") ? (8) : ((RESOLUTION == "160x120") ? (7) : (6))):0] x;
	input [((RESOLUTION == "320x240") ? (7) : ((RESOLUTION == "160x120") ? (6) : (5))):0] y;
	...
	wire [((RESOLUTION == "320x240") ? (16) : ((RESOLUTION == "160x120") ? (14) : (12))):0] user_to_video_memory_addr;
	/* This bus specifies the address in memory the user must write
	 * data to in order for the pixel intended to appear at location (X,Y) to be displayed
	 * at the correct location on the screen.
	 */

	wire [((RESOLUTION == "320x240") ? (16) : ((RESOLUTION == "160x120") ? (14) : (12))):0] controller_to_video_memory_addr;
	...
	assign valid_80x60 = (({1'b0, x} >= 0) & ({1'b0, x} < 80) & ({1'b0, y} >= 0) & ({1'b0, y} < 60)) & (RESOLUTION == "80x60");
	assign valid_160x120 = (({1'b0, x} >= 0) & ({1'b0, x} < 160) & ({1'b0, y} >= 0) & ({1'b0, y} < 120)) & (RESOLUTION == "160x120");
	assign valid_320x240 = (({1'b0, x} >= 0) & ({1'b0, x} < 320) & ({1'b0, y} >= 0) & ({1'b0, y} < 240)) & (RESOLUTION == "320x240");
	assign writeEn = (plot) & (valid_160x120 | valid_320x240 | valid_80x60);
	...
	defparam
		...
		VideoMemory.widthad_a = ((RESOLUTION == "320x240") ? (17) : ((RESOLUTION == "160x120") ? (15) : (13))),
		VideoMemory.numwords_a = ((RESOLUTION == "320x240") ? (76800) : ((RESOLUTION == "160x120") ? (19200) : (4800))),
		VideoMemory.widthad_b = ((RESOLUTION == "320x240") ? (17) : ((RESOLUTION == "160x120") ? (15) : (13))),
		VideoMemory.numwords_b = ((RESOLUTION == "320x240") ? (76800) : ((RESOLUTION == "160x120") ? (19200) : (4800))),
